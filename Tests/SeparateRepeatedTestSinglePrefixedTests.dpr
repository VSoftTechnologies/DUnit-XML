program SeparateRepeatedTestSinglePrefixedTests;
...
begin
  RegisterTests('SeparateRepeatedTestSinglePrefix', [
    TRepeatedTest.Create(TSucceedingTestCase.Suite, 3)
  ]);
  RunXmlOutputTestsCatchedOnConsole('SeparateRepeatedTestSinglePrefixedTests.xml');
end.
